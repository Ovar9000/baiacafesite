 ...
 * - `flatFee`: fixed delivery fee per order, regardless of item count.
 */

export const DELIVERY_MIN_DIRECTIONS_LENGTH = 10;

export const DELIVERY_FLAT_FEE = 120;
...
/**
 * Fixed delivery fee per zone. Returns 0 when zone is unknown/unselected
 * (fee hidden until zone is picked) or the cart is empty.
 */
 ...
 * Directions length. Returns { valid, error } for toasts.
 */
